...
#[
    ...
    OA\Server (url: 'https://laravel-sqlite-api-swagger-mze.azurewebsites.net', description: "staging server"), 
    OA\Server(url: 'https://laravel-sqlite-api-swagger-mze.azurewebsites.net', description: "production server"),
